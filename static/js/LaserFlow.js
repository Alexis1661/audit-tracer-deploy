/**
 * LaserFlow.js — Vanilla JavaScript Version
 * Adaptado de la versión React proporcionada por el usuario.
 */
...
class LaserFlow {
    ...
    init() {
        ...
        this.currentDpr = Math.min(window.devicePixelRatio || 1, 2);
    ...
    onResize() {
        ...
        this.uniforms.iResolution.value.set(w * this.currentDpr, h * this.currentDpr, this.currentDpr);
    ...
    onMouseMove(e) {
        ...
        this.mouseTarget.set(x * this.currentDpr, (this.rect.height - y) * this.currentDpr);
    }
    ...
    animate() {
        ...
        this.uniforms.uFlowTime.value += dt;
        this.uniforms.uFogTime.value += dt;
        ...
        const alpha = 1 - Math.exp(-dt / this.options.mouseSmoothTime);
